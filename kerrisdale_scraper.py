...
# Constants
JSON_URL = "https://www.kerrisdalecap.com/wp-json/wp/v2/media"
CHECK_INTERVAL = 5  # seconds
PROCESSED_URLS_FILE = "data/kerrisdale_processed_urls.json"
...
async def send_to_telegram(url, ticker):
    ...
    message = f"<b>New Kerrisdale Capital Report</b>\n\n"
