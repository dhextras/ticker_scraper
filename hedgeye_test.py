...
# {Num Of Accounts} x {Fetch interval} x {25} = 180 or 186 is extra safe but 180 is fine
# future me: Don't ask why 180, it works so stfu and use it
# If you were not using proxies use 420 instead
