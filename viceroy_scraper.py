...
# Constants
JSON_URL = "https://viceroyresearch.org/wp-json/wp/v2/media"
CHECK_INTERVAL = 1  # seconds
PROCESSED_URLS_FILE = "data/viceroy_processed_urls.json"
TELEGRAM_BOT_TOKEN = os.getenv("VICEROY_TELEGRAM_BOT_TOKEN")
TELEGRAM_GRP = os.getenv("VICEROY_TELEGRAM_GRP")
...
async def send_posts_to_telegram(urls):
    ...
    message = f"<b>New Viceroy Research medias found</b>\n\n"
...
async def send_to_telegram(url, ticker_obj: TickerAnalysis | str):
    ...
    message = f"<b>New Viceroy Research Ticker found</b>\n\n"
    message += f"<b>Time:</b> {timestamp}\n"
