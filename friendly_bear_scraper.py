...
# Constants
JSON_URL = "https://friendlybearresearch.com/wp-json/wp/v2/media"
CHECK_INTERVAL = 1  # seconds
PROCESSED_URLS_FILE = "data/friendlybear_processed_urls.json"
TELEGRAM_BOT_TOKEN = os.getenv("FRIENDLY_BEAR_TELEGRAM_BOT_TOKEN")
TELEGRAM_GRP = os.getenv("FRIENDLY_BEAR_TELEGRAM_GRP")
