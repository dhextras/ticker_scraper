...
# Constants
RSS_FEED_URL = "https://jehoshaphatresearch.com/author/jehoshaphat/feed"
CHECK_INTERVAL = 5
PROCESSED_GUIDS_FILE = "data/jehoshaphat_author_processed_guids.json"
...
async def send_post_to_telegram(post: Dict[str, Any]) -> None:
    ...
    message = f"<b>New Jehoshaphat Post - Author Feed</b>\n\n"
    ...
    log_message(f"Author RSS post sent to Telegram: {title}", "INFO")
