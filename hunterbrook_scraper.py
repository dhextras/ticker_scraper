...
# Constants
JSON_URL = "https://hntrbrk.com/wp-json/wp/v2/media"
CHECK_INTERVAL = 1  # seconds
PROCESSED_URLS_FILE = "data/hunterbrook_processed_urls.json"
...
async def send_posts_to_telegram(urls):
    ...
    message = f"<b>New Hunter Brook Research medias found</b>\n\n"
...
async def send_to_telegram(url, ticker_obj: TickerAnalysis | str):
    ...
    message = f"<b>New Hunter Brook Research Ticker found</b>\n\n"
    message += f"<b>Time:</b> {timestamp}\n"
